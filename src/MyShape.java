...
/* ----------------------------------------------------------
The Class MyShape is the hierarchy superclass and it inherits the
Java class Objects. An implementation of this class defines a
reference point (x, y) and the colors of the shape.
---------------------------------------------------------- */
