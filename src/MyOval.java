...
/* ----------------------------------------------------------
The Class MyOval inherited class from the MyShape class and like the other subclasses
in hierarchy may uses class MyRectangle.
---------------------------------------------------------- */
...
public class MyOval extends MyShape {
    ...
    MyOval(double x, double y, double widths, double heights, Color colors) {
    ...
    // New functions is implemented: getWidth and getHeight
    ...
    public String toString() {
        return String.format("----- The Oval Properties -----\n%15s (%.2f,%.2f)\n%15s %.2f\n%15s %.2f\n%15s %.2f\n%15s %.2f\n%15s " + super.getColor(),
